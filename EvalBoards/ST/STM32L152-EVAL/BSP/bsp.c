...
static void  BSP_LED_Init()
{
    ...
    gpio_init.GPIO_Pin   = BSP_GPIOD_LED1 | BSP_GPIOD_LED2;
...
void  BSP_LED_Off (CPU_INT08U  led)
{
    switch (led) {
        case 0:
             GPIO_SetBits(GPIOD, (BSP_GPIOD_LED1 | BSP_GPIOD_LED2));
             break;


        case 1:
             GPIO_SetBits(GPIOB, BSP_GPIOD_LED1);
             break;


        case 2:
             GPIO_SetBits(GPIOB, BSP_GPIOD_LED2);
             break;
...
void  BSP_LED_On (CPU_INT08U led)
{
    switch (led) {
        case 0:
             GPIO_ResetBits(GPIOB, (BSP_GPIOD_LED1 | BSP_GPIOD_LED2));
             break;


        case 1:
             GPIO_ResetBits(GPIOB, BSP_GPIOD_LED1);
             break;


        case 2:
             GPIO_ResetBits(GPIOB, BSP_GPIOD_LED2);
             break;
...
void  BSP_LED_Toggle (CPU_INT08U  led)
{
    ...
    switch (led) {
        case 0:
             ...
             pins ^= (BSP_GPIOD_LED1 | BSP_GPIOD_LED2);
             GPIO_SetBits(  GPIOD,   pins  & (BSP_GPIOD_LED1 | BSP_GPIOD_LED2));
             GPIO_ResetBits(GPIOD, (~pins) & (BSP_GPIOD_LED1 | BSP_GPIOD_LED2));
             break;
        ...
        case 1:
             ...
             pins ^= BSP_GPIOD_LED1;
             GPIO_SetBits(  GPIOB,   pins  & BSP_GPIOD_LED1);
             GPIO_ResetBits(GPIOB, (~pins) & BSP_GPIOD_LED1);
             break;
        ...
        case 2:
             pins  =  GPIO_ReadOutputData(GPIOB);
             pins ^= BSP_GPIOD_LED2;
             GPIO_SetBits(  GPIOB,   pins  & BSP_GPIOD_LED2);
             GPIO_ResetBits(GPIOB, (~pins) & BSP_GPIOD_LED2);
             break;
